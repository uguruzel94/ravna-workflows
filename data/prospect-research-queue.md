...
| 5 | `genetik laboratuvar` | `İzmir` | 25 | error | 2026-04-21 | DNS network hatası — Outscraper API'si erişilemedi, polling başarısız |
...
| 5 | `genetik laboratuvar` | `İzmir` | 2026-04-21 | 0 | 0 | ERROR: DNS network hatası — Outscraper API'si polling başarısız |
...
|-------|------|-------------|---------------------|-------|
| April 2026 | 5 | 150 | 350 | Run 1: error (network proxy). Run 2: 50 records, 5 cold_ready. Run 3: 50 records, 25 cold_ready. Run 4: 50 records, 46 cold_ready. Run 5: error (DNS network). |
| May 2026 | 0 | 0 | 500 | — |
